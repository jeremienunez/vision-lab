...
PerceptionLab documentation is organized around the Product Owning reference: product intent first, then architecture, QA, API contracts, roadmap, and sprint execution.
